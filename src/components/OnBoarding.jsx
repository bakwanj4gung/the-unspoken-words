        ...
        <div className='fixed z-99 bg-gray-900/90 pt-8 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 h-full w-full top-0 bottom-0 left-0 right-0'>
            <div className='relative md:mx-auto md:max-w-xl mx-auto'>
                ...
                `}>
                    ...
                    <Link href="/message/1" target='_blank' className='hover:text-slate-800 font-semibold hover:bg-slate-200 border-2 hover:border-transparent transition-all border-slate-200 bg-slate-800 text-slate-200 px-2 py-1 cursor-pointer rounded-lg'>Click this</Link>
                </div>
                <CardInput 
                    open={true} 
                ...
                <div className={`${step >= 5 ? 'flex' : 'hidden'} items-center mt-2`}>
                    <Link href="#write" onClick={handleClear} className='text-slate-800 text-center font-semibold bg-slate-200 border-2 border-transparent transition-all hover:border-slate-200 hover:bg-slate-800 hover:text-slate-200 w-full py-1 cursor-pointer rounded-lg'>Understood! I will start right now!</Link>
                </div>
            </div>
        </div>
    )
