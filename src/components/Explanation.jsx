...
import { kleeOne } from '@/lib/fonts'

export default function Explanation() {
    const [showModal, setShowModal] = useState(false)
    return (
        <div className={`${kleeOne.className} flex gap-4 flex-col lg:flex-row items-center justify-between mt-10`}>
            ...
            <Link href="#up" onClick={() => {setShowModal(true)}} className='flex flex-col items-center justify-center border p-5 rounded-lg w-full lg:h-60 lg:w-4/12 shadow-sm/0 transition-all duration-700 ease-in-out cursor-pointer hover:-translate-y-0.5 hover:shadow-lg/10'>
