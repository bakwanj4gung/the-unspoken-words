    ...
    return (
        <form
            ...
            <div
                className={`
                    ${gaegu.className}
                    text-lg border flex items-center gap-2 bg-white transition-all duration-500 focus-within:bg-transparent px-2 rounded-lg 
                    ${
                        effect ==
            ...
            <textarea
                ...
                className={`
                    ${gaegu.className}
                    text-base border flex grow w-full min-h-20 h-auto overflow-hidden outline-none bg-white p-2 rounded-lg transition-all duration-500 focus:bg-transparent placeholder:opacity-55 
                    ${
                        effect == "bg-white border-gray-700 text-gray-700"
